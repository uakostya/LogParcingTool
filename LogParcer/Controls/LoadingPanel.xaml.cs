...
namespace LogParcer.Controls {
    ...
    public partial class LoadingPanel {
        ...
        public static readonly DependencyProperty HaveCommandToRunProperty =
            DependencyProperty.Register("HaveCommandToRun", typeof(bool), typeof(LoadingPanel), new UIPropertyMetadata(false));
        ...
        public static readonly DependencyProperty VMRoutedCommandProperty =
            DependencyProperty.Register("VMRoutedCommand", typeof(ICommand), typeof(LoadingPanel));
        ...
        public bool HaveCommandToRun {
            get { return (bool)GetValue(HaveCommandToRunProperty); }
        ...
        public ICommand VMRoutedCommand {
            get { return (ICommand)GetValue(VMRoutedCommandProperty); }
            set { SetValue(VMRoutedCommandProperty, value); }
        }
